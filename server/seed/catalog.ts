...
const CATALOG_ITEMS: CatalogRow[] = [
  ...
  { name: 'America the Beautiful Quarter (Silver)', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.1808, purity: 0.900, year_start: 2010, year_end: 2021, mint: 'US Mint' },
  { name: 'Morgan Dollar', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.7735, purity: 0.900, year_start: 1878, year_end: 1921, mint: null },
  { name: 'Peace Dollar', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.7735, purity: 0.900, year_start: 1921, year_end: 1935, mint: null },
  { name: 'Walking Liberty Half Dollar', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.3618, purity: 0.900, year_start: 1916, year_end: 1947, mint: null },
  { name: 'Mercury Dime', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.0723, purity: 0.900, year_start: 1916, year_end: 1945, mint: null },
  { name: 'Washington Quarter', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.1808, purity: 0.900, year_start: 1932, year_end: 1964, mint: null },
  { name: 'Roosevelt Dime (Silver)', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.0723, purity: 0.900, year_start: 1946, year_end: 1964, mint: null },
  { name: 'Franklin Half Dollar', metal_type: 'silver', piece_type: 'coin', weight_oz: 0.3618, purity: 0.900, year_start: 1948, year_end: 1963, mint: null },

  // US Gold
  { name: 'American Gold Eagle 1oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 1, purity: 0.9167, year_start: 1986, year_end: null, mint: 'US Mint' },
  { name: 'American Gold Eagle 1/2oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.5, purity: 0.9167, year_start: 1986, year_end: null, mint: 'US Mint' },
  { name: 'American Gold Eagle 1/4oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.25, purity: 0.9167, year_start: 1986, year_end: null, mint: 'US Mint' },
  { name: 'American Gold Eagle 1/10oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.1, purity: 0.9167, year_start: 1986, year_end: null, mint: 'US Mint' },
  ...
  { name: 'Saint-Gaudens Double Eagle', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.9675, purity: 0.900, year_start: 1907, year_end: 1933, mint: null },
  { name: 'Liberty Head Double Eagle', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.9675, purity: 0.900, year_start: 1849, year_end: 1907, mint: null },
  ...
  // South African
  { name: 'Krugerrand 1oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 1, purity: 0.9167, year_start: 1967, year_end: null, mint: 'South African Mint' },
  { name: 'Krugerrand 1/2oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.5, purity: 0.9167, year_start: null, year_end: null, mint: null },
  { name: 'Krugerrand 1/4oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.25, purity: 0.9167, year_start: null, year_end: null, mint: null },
  { name: 'Krugerrand 1/10oz', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.1, purity: 0.9167, year_start: null, year_end: null, mint: null },
  ...
  { name: 'Sovereign', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.2354, purity: 0.9167, year_start: 1817, year_end: null, mint: 'Royal Mint' },
  { name: 'Half Sovereign', metal_type: 'gold', piece_type: 'coin', weight_oz: 0.1177, purity: 0.9167, year_start: null, year_end: null, mint: 'Royal Mint' },
